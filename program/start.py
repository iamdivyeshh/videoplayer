...
async def start_(client: Client, message: Message):
    await message.reply_sticker("CAACAgUAAx0CR8x-HAACA4Bh--Sk8zzoNPaHx7jrSuYAAUXrzW8AAq0DAAI06zlUtO5y4ptm1csjBA")
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("ᴄʀᴇᴀᴛᴏʀ", url=f"https://t.me/zaynxop"),
                ],
                [
                    InlineKeyboardButton(
                        "ʙᴏᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/HINDICHATINGGROUP"
                    ),
                    InlineKeyboardButton(
                        "ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/brokenheartshayar"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url=f"https://t.me/HINDICHATINGGROUP"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("ʙᴏᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/HINDICHATINGGROUP"),
                InlineKeyboardButton(
                    "ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/brokenheartshayar"
                ),
            ]
