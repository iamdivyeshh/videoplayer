...
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "ɢʀᴏᴜᴘ", url=f"https://t.me/HINDICHATINGGROUP"
                    ),
                    InlineKeyboardButton(
                        "ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/brokenheartshayar"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "Sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/HINDICHATINGGROUP"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("ɢʀᴏᴜᴘ", url=f"https://t.me/HINDICHATINGGROUP"),
                InlineKeyboardButton(
                    "ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/brokenheartshayar"
                ),
            ]
