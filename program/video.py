        ...
        [
            [
                InlineKeyboardButton(
                    text="ʙᴏᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/HINDICHATINGGROUP"
                ),
                InlineKeyboardButton(
                    text="ʙᴏᴛ ᴄʜᴀᴀɴɴᴇʟ", url=f"https://t.me/brokenheartshayar"
                ),
            ]
        ]
    )
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/brokenheartshayar"
                ),
            ]
        ]
    )
