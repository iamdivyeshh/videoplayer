        ...
        [
            [
                InlineKeyboardButton(
                    text="ɢʀᴏᴜᴘ", url=f"https://t.me/HINDICHATINGGROUP"
                ),
                InlineKeyboardButton(
                    text="ᴄʜᴀᴀɴɴᴇʟ", url=f"https://t.me/brokenheartshayar"
                ),
            ]
        ]
    )
    ...
    if replied:
        if replied.video or replied.document:
            ...
            if chat_id in QUEUE:
                ...
                await loser.delete()
                await m.reply_photo(
                    photo=f"https://telegra.ph/file/6017c19c57946e03e650f.jpg",
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/brokenheartshayar"
                ),
            ]
        ]
    )
